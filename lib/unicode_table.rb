...
class UnicodeConverter
  ...
  def save(target)
    ...
    open((target), 'w'){|cs|
      ...
      cs.puts "module.exports = Mapping = {}"
      cs.puts "Mapping.toLaTeX = { unicode: {}, ascii: {}, embrace: {} }"
      ...
      %w{unicode ascii}.each{|encoding|
        ...
        %w{math text}.each{|mode|
          ...
          cs.puts "Mapping.toLaTeX.#{encoding}.#{mode} =\n" + mappings[mode].join('')
        }
      }
      cs.puts "Mapping.toLaTeX.embrace ="
