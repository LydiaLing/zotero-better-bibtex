  ...
  while item = Exporter.nextItem()
    ...
    switch
      ...
      when ref.isBibVar(item.publicationTitle)
        ...
        ref.add({ name: 'journal', value: Translator.options.useJournalAbbreviation && Zotero.BetterBibTeX.journalAbbrev(item) || item.publicationTitle, preserveBibTeXVariables: true })
