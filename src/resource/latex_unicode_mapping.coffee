...
Mapping.toLaTeX = { unicode: {}, ascii: {}, embrace: {} }
Mapping.toLaTeX.unicode.math =
  '<': "<" # LESS-THAN SIGN
  '>': ">" # GREATER-THAN SIGN
  '\\': "\\backslash{}"
Mapping.toLaTeX.unicode.text =
  '#': "\\#" # NUMBER SIGN
  '$': "\\$"
  '%': "\\%" # PERCENT SIGN
  '&': "\\&"
